...
class ProductChecks extends Component {
    constructor() {
        super();
        this.state = {
            FilterClothes: [
        ...
        return (
            <React.Fragment>
                <div className="page-content">
                    <Container fluid>
                        <Breadcrumbs title="Products" breadcrumbItem="Products Checkout" />
                        <Row>
                            <Col lg="3">
                                <Card>
                                    <CardBody>
                                            ...
                                            <ul className="list-unstyled product-list">
                                                {
                                                    this.state.FilterClothes.map((cloth, key) =>
                                                        <li key={"_li_" + key}><Link to={cloth.link}><i className="mdi mdi-chevron-right mr-1"/>{cloth.name}</Link></li>
                                                    )
                                                }
                                            </ul>
                                        </div>
